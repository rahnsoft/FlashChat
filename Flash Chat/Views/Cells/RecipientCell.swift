...
class RecipientCell: UITableViewCell {
    ...
    func constraintsAll() {
        ...
        NSLayoutConstraint.activate([
            ...
            label.widthAnchor.constraint(lessThanOrEqualToConstant: UIScreen.main.bounds.size.width / 1.8),
            ...
            avatarImage.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -Constants.DEFAULT_PADDING)
        ]
        )
    }
